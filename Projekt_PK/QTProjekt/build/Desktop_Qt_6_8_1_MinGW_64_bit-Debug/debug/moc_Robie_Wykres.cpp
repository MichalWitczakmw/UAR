...
namespace {
struct qt_meta_tag_ZN11RobieWykresE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN11RobieWykresE = QtMocHelpers::stringData(
    "RobieWykres",
    "aktualizacjawykresu",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11RobieWykresE[] = {
...
Q_CONSTINIT const QMetaObject RobieWykres::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11RobieWykresE.offsetsAndSizes,
    qt_meta_data_ZN11RobieWykresE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11RobieWykresE_t,
        // Q_OBJECT / Q_GADGET
...
void RobieWykres::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->aktualizacjawykresu(); break;
        default: ;
        }
    }
    (void)_a;
...
void *RobieWykres::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11RobieWykresE.stringdata0))
