...
namespace {
struct qt_meta_tag_ZN14mainOknoZapisuE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN14mainOknoZapisuE = QtMocHelpers::stringData(
    "mainOknoZapisu",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14mainOknoZapisuE[] = {
...
Q_CONSTINIT const QMetaObject mainOknoZapisu::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14mainOknoZapisuE.offsetsAndSizes,
    qt_meta_data_ZN14mainOknoZapisuE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14mainOknoZapisuE_t,
        // Q_OBJECT / Q_GADGET
...
void *mainOknoZapisu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14mainOknoZapisuE.stringdata0))
